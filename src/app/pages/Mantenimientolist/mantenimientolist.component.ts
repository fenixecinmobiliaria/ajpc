...
@Component({
  selector: 'app-mantenimientolist',
  standalone: true,
  imports: [CommonModule, FormsModule],
  templateUrl: './mantenimientolist.component.html',
  styleUrls: ['./mantenimientolist.component.css']
})
export class MantenimientolistComponent implements OnInit {
  ...
  private section: 'maintenance' = 'maintenance';
  ...
  // 🔹 Carga todos los videos de la colección “maintenanceVideos”
